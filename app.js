...
App({
  globalData: {
    ...
    appInfo: {
      name: '魔方云尛程序 ',
      appId: 'wx0ca4187987ebe63a',
      appSecret: 'f67bb52069613467c1ae13ab9fac160',
      appKey: '',
      type: 106,
      version: '1.0.0',
    },
    //【域名】
    //  domainName: 'http://192.168.1.63:8080/shop-web',   //域名
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        if (returnData.code == 0) {
          ...
          if (!returnData.result.vipInfo.vip_level){
            app.globalData.customerInfo.vipInfo.vip_level = 0;
          }
