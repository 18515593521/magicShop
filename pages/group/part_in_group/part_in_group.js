...
Page({
  ...
  getProductDetails: function () {
    ...
    console.log('产品customerId' + app.globalData.customerInfo.id);
    wx.request({
      ...
      fail: function (res) {     //失败
        console.log('请求失败的原因是什么', JSON.stringify(res.errMsg));
      },
  ...
  getgroupList: function (e) {
    var thisPage = this;
    console.log("线上吗------" + thisPage.data.groupType);
    ...
    console.log("app.globalData.customerInfo.id" + app.globalData.customerInfo.id);
    console.log("thisPage.data.customer_group_buying_id" + app.globalData.customerInfo.id);
    wx.request({
