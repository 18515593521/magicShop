...
Page({
  ...
  onShareAppMessage: function () {
    ...
    var param = 'P1=L&types=1&groupBuyingId=' + thisPage.data.groupBuyingId + '&productId=' + thisPage.data.product_id + '&P4=' + app.globalData.customerInfo.id + '&customerGroupBuyingId=' + thisPage.data.customerGroupBuyingId  ;
